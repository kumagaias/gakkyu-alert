...
output "amplify_url" {
  description = "URL of the deployed prd environment (Amplify default domain)"
...
output "api_custom_domain_url" {
  description = "API Gateway のカスタムドメイン URL"
  value       = var.custom_domain != null ? "https://api.${var.custom_domain}" : null
}
